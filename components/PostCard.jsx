...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="p-0 pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8">
      ...
      <h1 className="mb-8 text-3xl font-semibold text-center transition duration-700 cursor-pointer hover:text-bgColor">
      ...
      <p className="px-4 mb-8 text-lg font-normal text-center text-txtColor lg:px-20">
        {post.excerpt}
      </p>
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="inline-block px-8 py-3 text-lg font-medium text-white transition duration-500 transform rounded-full cursor-pointer bg-bgColor ease hover:-translate-y-1">
            Continue Reading
          </span>
        </Link>
      </div>
